    ...
    <div className="min-h-screen bg-[#0E1A1F] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#FFFFFF]/5 rounded-3xl p-8 border border-[#FFFFFF]/10">
          ...
          <p className="text-[#FFFFFF]/50 text-sm mb-8">Sign in to your admin account</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Email */}
            <div>
              <label className="block text-sm font-medium text-[#FFFFFF]/70 mb-2">
                Email Address
              </label>
              <input
                type="email"
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-sm font-medium text-[#FFFFFF]/70">Password</label>
                <Link href="/forgot-password" className="text-xs text-[#C8F904] hover:underline">
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="text-center text-[#FFFFFF]/40 text-sm mt-6">
            ...
            <Link href="/register" className="text-[#C8F904] hover:underline font-medium">
              Register
            </Link>
          </p>
        </div>
